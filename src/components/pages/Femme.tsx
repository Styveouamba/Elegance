    ...
    <div className="min-h-screen bg-white text-black relative">
      ...
      <section className="py-16 bg-white text-center px-6">
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl font-light leading-relaxed text-gray-700">
          Découvrez notre sélection exclusive de vêtements pour femmes. Élégance, modernité et style minimaliste.
        </p>
      </section>

      {/* Grille des produits femmes */}
      <ProductGrid query="femme fashion minimal" title="Nos Sélections Femme" />
    </div>
  );
};
